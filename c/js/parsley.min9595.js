    ...
    validators: {
      ...
      type: function (type) {
        ...
        case 'pincode_outside':
            ...
            break;
        case 'aadhaar_no':
            assert = new Validator.Assert().Regexp('^[0-9]{12}$|^[0-9]{28}$', 'i');
            break;
            
        case 'zipcode':
            assert = new Validator.Assert().Regexp('^([a-zA-Z0-9_-]){1,8}$', 'i');
            break;
          default:
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  type: {
    ...
    digits:			"Enter numbers without decimals.",
